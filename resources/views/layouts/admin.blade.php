    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('admin.posts.edit')}}">Sửa</a>
                        <a class="collapse-item" href="{{route('admin.posts.delete')}}">Xóa</a> --}}
                    </div>
                </div>
            </li>
            @can('users')
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('admin.users.edit')}}">Sửa</a>
                        <a class="collapse-item" href="{{route('admin.users.delete')}}">Xóa</a> --}}
                    </div>
                </div>
            </li>
            @endcan
            ...
            <li class="nav-item">
                ...
                <div id="group" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <a class="collapse-item" href="{{route('admin.groups.add')}}">Thêm</a>
                        <a class="collapse-item" href="{{route('admin.groups.edit')}}">Sửa</a>
                        <a class="collapse-item" href="{{route('admin.groups.delete')}}">Xóa</a> --}}
                    </div>
                </div>
            </li>
            @endcan
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                onclick="event.preventDefault();"  data-toggle="modal" data-target="#logoutModal">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Chon đăng xuất bạn sẽ thoát khỏi phiên đăng nhập</div>
